...
// CHECK-NEXT: node_2[label="clEnqueueCopyImage"];
...
int main() {
  ...
  Ret = clEnqueueCopyImage(State.OutOfOrderQueue, State.ImageA, State.ImageB,
                           Origin, Origin, Region, 1, &Events[0], &Events[1]);
  CHECK(Ret);
