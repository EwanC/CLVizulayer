...
int main() {
  ...
  Ret = clEnqueueMarker(State.OutOfOrderQueue, &Events[0]);
  CHECK(Ret);
  ...
  Ret = clEnqueueMarker(State.OutOfOrderQueue, &Events[1]);
  CHECK(Ret);
