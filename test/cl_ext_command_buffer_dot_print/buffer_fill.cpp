...
// CHECK-NEXT: node_0[label="clCommandFillBufferKHR
...
int main() {
  ...
  Ret = State.clCommandFillBufferKHR(
      command_buffer, nullptr, nullptr, State.BufferA, &Pattern,
      sizeof(Pattern), 0, State.AllocSize, 0, nullptr, nullptr, nullptr);
