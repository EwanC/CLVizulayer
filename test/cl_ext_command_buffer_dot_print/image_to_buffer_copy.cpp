...
// CHECK-NEXT: node_0[label="clCommandCopyImageToBufferKHR
...
int main() {
  ...
  Ret = State.clCommandCopyImageToBufferKHR(
      command_buffer, nullptr, nullptr, State.ImageA, State.BufferA, Origin,
