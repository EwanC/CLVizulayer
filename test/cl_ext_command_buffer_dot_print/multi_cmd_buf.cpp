...
// CHECK1-NEXT: node_2[label="clCommandNDRangeKernelKHR"];
// CHECK1-NEXT: }
// CHECK1-NEXT: node_0 -> node_2
// CHECK1-EMPTY:
// CHECK1-NEXT: }
...
// CHECK2-NEXT: node_3[label="clCommandNDRangeKernelKHR"];
// CHECK2-NEXT: }
// CHECK2-EMPTY:
// CHECK2-NEXT: }
...
int main() {
  ...
  cl_command_buffer_khr CommandBuffer1 =
      State.clCreateCommandBufferKHR(1, &State.InOrderQueue, nullptr, &Ret);
  CHECK(Ret);
  CHECK_NOT_NULL(CommandBuffer1);

  cl_command_buffer_khr CommandBuffer2 =
      State.clCreateCommandBufferKHR(1, &State.OutOfOrderQueue, nullptr, &Ret);
  CHECK(Ret);
  CHECK_NOT_NULL(CommandBuffer2);

  Ret = State.clCommandNDRangeKernelKHR(
      CommandBuffer1, nullptr, nullptr, State.Kernel, 1, nullptr,
      &State.GlobalSize, nullptr, 0, nullptr, nullptr, nullptr);

  CHECK(Ret);

  Ret = State.clCommandNDRangeKernelKHR(
      CommandBuffer2, nullptr, nullptr, State.Kernel, 1, nullptr,
      &State.GlobalSize, nullptr, 0, nullptr, nullptr, nullptr);
  CHECK(Ret);
  ...
  CHECK(State.clReleaseCommandBufferKHR(CommandBuffer2));
