...
// CHECK-NEXT: node_2[label="clEnqueueFillImage"];
...
int main() {
  ...
  cl_float Color[4] = {1.0f, 1.0f, 1.0f, 1.0f};
  size_t Origin[3] = {0, 0, 0};
  size_t Region[3] = {2, 2, 1};
  Ret = clEnqueueFillImage(State.OutOfOrderQueue, State.ImageA, &Color, Origin,
                           Region, 1, &Events[0], &Events[1]);
  CHECK(Ret);
